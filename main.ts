...
let trash1 = sprites.create(assets.image`myImage`, SpriteKind.Trash)
trash = sprites.create(assets.image`potion12`, SpriteKind.Trash)
let trash2 = sprites.create(assets.image`potion12`, SpriteKind.Trash)
let trash3 = sprites.create(assets.image`myImage`, SpriteKind.Trash)
